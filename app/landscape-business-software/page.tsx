...
export default function LandscapeBusinessSoftware() {
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <h1>Landscape Business Software<br /><span>Built for Install, Design-Build &amp; Maintenance</span></h1>
      ...
      <div style={{background:'var(--purple-dark)', padding:'0 40px 60px', textAlign:'center'}}>
        <img
          ...
          fetchPriority="high"
          decoding="async"
          alt="LandscapeBossPro landscape business software dashboard on laptop showing the job board, line-item estimates, and crew dispatch, with mobile app on phone"
      ...
      <div className="premium-band">
        ...
        <div className="premium-grid">
          <div className="premium-card"><div className="premium-card-icon">📐</div><h4>Line-Item Estimating</h4><p>Build detailed bids with separate lines for labor, materials, and products &mdash; mulch by the yard, sod by the pallet, plants by the each, pavers by the square foot. Email the estimate and let the client accept with one click.</p></div>
          <div className="premium-card"><div className="premium-card-icon">📦</div><h4>Materials &amp; Products</h4><p>Track every material and product across every job &mdash; what was quoted, what was ordered, what was installed, and what it cost you. Build a reusable product catalog with your real prices so every bid is accurate.</p></div>
          ...
          <div className="premium-card"><div className="premium-card-icon">💳</div><h4>Stripe Payments</h4><p>Cards on file, deposits, progress billing, invoicing, and payment tracking &mdash; the full Stripe integration is wired in. Your clients can pay instantly and you can see every dollar collected in one place.</p></div>
          ...
          <div className="premium-card"><div className="premium-card-icon">📱</div><h4>Mobile App for Your Crew</h4><p>Your crews get a mobile-optimized dashboard with their jobs for the day. Complete, skip, reschedule, log notes, and snap before-and-after photos &mdash; all from the truck without calling the office once.</p></div>
        </div>
      </div>
      ...
      <section className="dark-section">
        <div className="highlight-row">
          <div className="highlight-text">
            <span className="section-label">The Job Board — Your Operation in One View</span>
            <h2 style={{color:'#fff'}}>Every Install, Every Maintenance Stop, Every Crew &mdash; on One Board.</h2>
            <p style={{color:'rgba(255,255,255,.65)'}}>The job board is the fastest way to run a landscaping operation we&apos;ve ever built. Drag a multi-day patio install across the week, drop a sod job onto an open crew, and watch your recurring maintenance stops fill in automatically &mdash; with crew, truck, materials, and projected revenue all calculated in real time before you commit to a single schedule.</p>
            <ul className="check-list" style={{marginTop:'20px'}}>
              <li style={{color:'rgba(255,255,255,.75)'}}>See every install, design-build, and maintenance job in one view</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Drag-and-drop jobs onto crews and dates in seconds</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Multi-day projects span the calendar so nothing gets double-booked</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Recurring maintenance routes generate automatically every cycle</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Materials and products attach to each job so the crew shows up ready</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Tighten routes geographically &mdash; no more scattered stops burning fuel</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Cuts weekly scheduling from hours to minutes</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>One board for the whole company &mdash; office and crews stay in sync</li>
            </ul>
          </div>
          <div className="highlight-visual">
            ...
            <div style={{background:'rgba(255,255,255,.04)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'10px', padding:'20px', marginBottom:'14px', position:'relative', minHeight:'130px', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden'}}>
              ...
              <div style={{display:'flex', gap:'12px', flexWrap:'wrap', justifyContent:'center', position:'relative', zIndex:1}}>
                {['s','s','u','s','s','s','u','s','s','u','s','s','s','u','s','s','s','u','s'].map((t,i) => (
                  <div key={i} style={{width:'11px', height:'11px', borderRadius:'3px', flexShrink:0, background: t==='s' ? '#1b6e3b' : 'rgba(255,255,255,.2)', boxShadow: t==='s' ? '0 0 0 3px rgba(27,110,59,.3)' : 'none'}}></div>
                ))}
              </div>
            </div>
            <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'8px'}}>
              ...
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px'}}>
                <div style={{color:'#1b6e3b', fontSize:'18px', fontWeight:800}}>4</div>
              ...
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px'}}>
                <div style={{color:'#1b6e3b', fontSize:'18px', fontWeight:800}}>32</div>
                <div style={{color:'rgba(255,255,255,.42)', fontSize:'11px', marginTop:'1px'}}>Maintenance Stops</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', gridColumn:'span 2'}}>
                <div style={{color:'#fff', fontSize:'13px', fontWeight:600}}>Installs · 5 &nbsp;|&nbsp; Hardscape · 3 &nbsp;|&nbsp; Maintenance · 6</div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          ...
          <p className="section-sub" style={{maxWidth:'720px'}}>Most powerful software is complicated. LandscapeBossPro is the exception. Every screen was designed by people who ran install crews and maintenance routes &mdash; not UX designers who&apos;ve never loaded a skid steer. Your team will be using it confidently on day one.</p>
        </div>
        <div style={{display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(240px, 1fr))', gap:'24px', maxWidth:'1100px', margin:'0 auto'}}>
          {[
            ...
            {n:'03', title:'Your Crews Learn It in Minutes', body:'The mobile app your crews use shows them exactly what they need and nothing they don\'t. Their jobs for the day, the property info, the material list, the job notes, and the complete button. No training videos, no IT ticket, no frustrated crew members.'},
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto'}}>
          ...
          <p className="section-sub">Landscaping is not plumbing. You&apos;re not sending one tech to one job for two hours. You&apos;re managing multi-day installs, line-item bids, pallets of sod and yards of mulch, design-build projects, and a recurring maintenance route that never stops.</p>
        </div>
        <div style={{maxWidth:'900px', margin:'0 auto'}}>
          <div style={{background:'#fff', border:'1.5px solid var(--border)', borderRadius:'14px', padding:'36px 40px', borderLeft:'5px solid var(--orange)'}}>
            <p style={{fontSize:'17px', color:'var(--text)', lineHeight:1.8, marginBottom:'16px'}}>When we were running our own crews, we tried every piece of software out there. The big names, the small names, the ones built for &quot;field service.&quot; None of them understood what it meant to bid a <strong>$30,000 paver patio with three days of labor and four kinds of material</strong> and still run a 40-stop maintenance route the same week.</p>
      ...
      <section>
        ...
        <div className="feature-grid">
          {[
            {icon:'📐', title:'Line-Item Estimates', body:'Build a landscape estimate with separate lines for labor, materials, and products — mulch by the yard, sod by the pallet, plants by the each, pavers by the square foot. Email it from the platform and let clients accept with one click.'},
            {icon:'📦', title:'Materials & Products Tracking', body:'Track every material and product on every job — what was quoted, ordered, and installed, and what it cost you. Build a reusable catalog with your real prices so every bid is accurate and your margin is protected.'},
            {icon:'🗓️', title:'Project Scheduling', body:'Schedule single-visit jobs and multi-day installs on one calendar. Drag a patio build across the week, block crew time, and keep big projects from colliding with your maintenance route.'},
            {icon:'📋', title:'The Job Board', body:'Every install, hardscape, planting, sod, and maintenance job on one board. Drag jobs onto crews and dates, see what\'s booked vs. open, and run your whole week from a single screen.'},
            {icon:'🚛', title:'Crew Dispatch & Routing', body:'Assign jobs to crews and trucks, order stops geographically to cut drive time, and push the day\'s route straight to each crew\'s phone. Everyone knows where to be and what to bring.'},
            {icon:'🔁', title:'Recurring Maintenance Plans', body:'Set up recurring maintenance and mowing schedules — weekly, biweekly, or custom. LandscapeBossPro generates the stops automatically every cycle and keeps your route full all season.'},
            {icon:'💬', title:'Automated Job Alerts', body:'Automatically text clients when a job is scheduled, when your crew is on the way, and when the work is done. Set it once — LandscapeBossPro handles the communication for every job and every stop.'},
            {icon:'💳', title:'Card-on-File Billing', body:'Store cards on file via Stripe. Collect deposits up front, bill progress payments on big installs, and charge recurring maintenance automatically. Every dollar tracked in one place.'},
            {icon:'🏠', title:'Client & Property Profiles', body:'Every property has its own record — service history, photos, GPS coordinates, gate codes, material notes, and every estimate and invoice. Everything tied to the address, not just the customer.'},
            ...
            {icon:'💵', title:'Payment Follow-Up Sequences', body:'Unpaid invoices trigger 3 automated payment reminder texts. Collect what you\'re owed on installs and maintenance without making uncomfortable calls.'},
            ...
            {icon:'📄', title:'Invoicing & Payments', body:'Convert accepted estimates to invoices instantly. Filter by unpaid, partial, paid, or overdue. Every dollar tracked with full payment history, method, and date.'},
            ...
            {icon:'🚚', title:'Truck & Equipment Management', body:'Create truck profiles, assign vehicles and equipment to jobs, and track which crew and truck handled each project. Know exactly what\'s rolling out every day.'},
            {icon:'⏱️', title:'Employee Hour Tracking', body:'Track employee hours per job and generate payroll-ready reports. Know your real labor cost on every install before payday without running a separate system.'},
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="highlight-row">
          <div className="highlight-text">
            <span className="section-label">Landscape Estimating</span>
            <h2>Build a Line-Item Bid in Minutes &mdash; Labor, Materials, and Products, All Priced Right</h2>
            <p>This is where landscaping jobs are won or lost. LandscapeBossPro&apos;s estimate builder lets you price a job line by line &mdash; mulch by the yard, sod by the pallet, plants by the each, and pavers by the square foot &mdash; pulling from your own product catalog so the numbers are always right. For a closer look at how the software runs an install and maintenance company end to end, read <a href="/blogs/landscape-business-software-what-it-is" style={{color:'var(--orange)', fontWeight:600}}>What Landscape Business Software Actually Does for an Install &amp; Maintenance Company</a>.</p>
            <ul className="check-list">
              <li>Separate lines for labor, materials, and products on every bid</li>
              <li>Reusable product catalog with your real costs and prices</li>
              <li>Quote mulch, sod, plants, and pavers by their real unit</li>
              ...
              <li>Collect a deposit at signing and bill progress payments after</li>
              <li>Automated follow-up texts if a client goes quiet</li>
              <li>See projected revenue and material cost on every job</li>
            </ul>
          </div>
          <div className="highlight-visual">
            <div style={{color:'rgba(255,255,255,.5)', fontSize:'11px', textTransform:'uppercase', letterSpacing:'1px', marginBottom:'14px'}}>Estimate — Backyard Patio &amp; Planting</div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              ...
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Paver Patio — 420 ft²</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>Material + labor</div></div>
              <div style={{marginLeft:'auto', background:'#16a34a', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>$11,800</div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#1b6e3b', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Sod — 6 pallets</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>Delivered &amp; installed</div></div>
              <div style={{marginLeft:'auto', background:'#1b6e3b', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>$2,640</div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#d4a017', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Mulch — 14 yards</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>Beds &amp; borders</div></div>
              <div style={{marginLeft:'auto', background:'#2272c3', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>$1,120</div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#22c55e', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Plantings — 38 each</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>Shrubs &amp; perennials</div></div>
              <div style={{marginLeft:'auto', background:'#16a34a', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>$2,210</div>
            </div>
            <div style={{marginTop:'16px', background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'14px 16px', textAlign:'center'}}>
              <div style={{color:'#1b6e3b', fontSize:'16px', fontWeight:700}}>Priced right, every time.</div>
              <div style={{color:'rgba(255,255,255,.45)', fontSize:'12px', marginTop:'4px'}}>Pulled straight from your product catalog.</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="highlight-row reverse">
          <div className="highlight-text">
            ...
            <h2>Track Every Yard of Mulch, Pallet of Sod, and Paver on the Job</h2>
            <p>Landscaping lives and dies on materials. LandscapeBossPro tracks every product across every job &mdash; what you quoted, what you ordered, and what you actually installed &mdash; so you always know your real cost and your real margin before you cash the check.</p>
            <ul className="check-list">
              <li>Build a product catalog with your real unit costs and prices</li>
              <li>Quote and track mulch, sod, plants, stone, and pavers</li>
              <li>See quoted vs. installed quantities on every job</li>
              <li>Attach the material list to each job so crews load right</li>
              <li>Roll material cost into estimates automatically</li>
              <li>Compare projected margin against actual job cost</li>
              <li>Reuse priced line items across every new bid</li>
            </ul>
          </div>
          <div className="highlight-visual">
            <div style={{color:'rgba(255,255,255,.5)', fontSize:'11px', textTransform:'uppercase', letterSpacing:'1px', marginBottom:'14px'}}>Materials — June 2026</div>
            <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'8px', marginBottom:'12px'}}>
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
                ...
                <div style={{color:'rgba(255,255,255,.45)', fontSize:'11px'}}>Yards of Mulch</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
                <div style={{color:'#fff', fontSize:'20px', fontWeight:700}}>54</div>
                <div style={{color:'rgba(255,255,255,.45)', fontSize:'11px'}}>Pallets of Sod</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
                <div style={{color:'#1b6e3b', fontSize:'20px', fontWeight:700}}>9,400</div>
                <div style={{color:'rgba(255,255,255,.45)', fontSize:'11px'}}>Pavers Installed</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
                <div style={{color:'#1b6e3b', fontSize:'20px', fontWeight:700}}>1,340</div>
                <div style={{color:'rgba(255,255,255,.45)', fontSize:'11px'}}>Plants Set</div>
              </div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#22c55e', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Patio Build · 420 ft²</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>Crew A · 3-day install</div></div>
              <div style={{background:'#16a34a', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>On budget</div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#1b6e3b', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Front Yard Re-Sod · 6 pallets</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>Crew B · 1-day install</div></div>
              <div style={{background:'#1b6e3b', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>Quoted</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{background:'#fff'}}>
        <div style={{maxWidth:'860px', margin:'0 auto', padding:'80px 40px'}}>
          ...
          <h2 className="section-title" style={{marginBottom:'48px'}}>Landscape Business Software — Common Questions</h2>
          {[
            {q:'Is LandscapeBossPro built for landscaping businesses?', a:'Yes. LandscapeBossPro handles the full landscaping operation: line-item estimating, materials and products tracking, project scheduling for multi-day installs, crew dispatch, recurring maintenance plans, automated client SMS, and card-on-file billing. It\'s designed for install, design-build, hardscape, and maintenance companies — not general service businesses.'},
            {q:'Can I run installs and recurring maintenance from one platform?', a:'Yes. LandscapeBossPro puts multi-day installs, hardscape and planting projects, and recurring maintenance and mowing routes on one job board. You can schedule a paver patio build and a 40-stop maintenance route in the same week without them colliding, each with its own crew, materials, and alerts.'},
            {q:'How do estimates and bids work in LandscapeBossPro?', a:'You build a bid line by line — labor, materials, and products — pulling from your own product catalog so prices are always right. Quote mulch by the yard, sod by the pallet, plants by the each, and pavers by the square foot. Email the estimate, let the client accept with one click, and convert it to a scheduled job instantly.'},
            {q:'Does LandscapeBossPro track materials and products?', a:'Yes. Every job tracks the materials and products you quoted, ordered, and installed, with your real unit costs. You always know your projected margin before the job starts and your actual cost when it\'s done — no separate spreadsheet required.'},
            {q:'Does it replace spreadsheets and scheduling apps?', a:'Yes. LandscapeBossPro replaces spreadsheet estimating, material lists, scheduling, route planning, client tracking, invoicing, and SMS communication in one platform. Most owners are fully operational the same day they sign up — no onboarding consultant, no implementation timeline.'},
            {q:'How much does LandscapeBossPro cost?', a:'$129/month, all features included. No per-user fees, no add-ons for SMS or the job board, no setup fees. 14-day free trial with no credit card required.'},
          ].map(({q, a}, i, arr) => (
          ...
          <p style={{marginTop:'40px', color:'var(--muted)', fontSize:'15px', lineHeight:1.7}}>LandscapeBossPro runs landscape installs, design-build, hardscape, planting, sod, mulch, and recurring maintenance crews &mdash; all from one platform &mdash; <a href="/" style={{color:'var(--orange)', fontWeight:600}}>LandscapeBossPro</a>.</p>
        </div>
      </section>
