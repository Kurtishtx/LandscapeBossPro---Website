...
export const metadata = {
  title: 'How to Close a Mosquito Spray Season | LandscapeBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>LandscapeBossPro ties season close to treatment completion events — so the last-treatment message, renewal prompt, and annual compliance report all flow from the same operational workflow.</p>
          <a href="https://my.landscapebosspro.com">Start Free Trial</a>
        </div>

        <div className="blog-keywords">
          Keywords: close mosquito spray season software, mosquito spray season end customer communication, mosquito spray last treatment communication, mosquito spray business season close, mosquito spray renewal customer retention, end of season mosquito spray message
        </div>
      </article>
    </BlogShell>
  );
