...
export const metadata = {
  title: 'Setting Up LandscapeBossPro: Your First Week with Landscape Business Software | LandscapeBossPro',
  description: 'A practical first-week setup guide for LandscapeBossPro&mdash;load properties, build estimate templates, set materials, and schedule crews in days, not weeks.',
};
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        ...
        <h2>Day 1: Build Your Client and Property Profiles</h2>
        <p>
