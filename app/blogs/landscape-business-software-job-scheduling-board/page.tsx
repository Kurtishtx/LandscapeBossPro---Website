...
export const metadata = {
  title: 'Using the Job Board to Schedule Installs and Maintenance Visits | LandscapeBossPro',
  description: 'See how the LandscapeBossPro job board schedules installs and recurring maintenance visits, dispatches crews, and turns finished work into invoices.',
};
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        ...
        <h2>Turning Estimates Into Scheduled Jobs</h2>
        <p>
          Scheduling starts long before a crew rolls out. When a customer approves a line-item estimate &mdash; whether it&apos;s a mulch refresh or a multi-phase hardscape build &mdash; that estimate becomes a job on the board with all of its details intact. You don&apos;t re-key the address, the scope, or the materials. The plant takeoffs, the yards of sod, the pavers, and the labor estimate all carry over, so the crew sees exactly what was sold. For a full breakdown of how a large job moves from a signed proposal all the way through to billing, see <a href="/blogs/landscape-business-software-design-build-workflow">Running a Design-Build Project from Proposal to Final Invoice</a>.
        </p>
        <p>
        ...
        <h2>Dispatch, Routing, and Crew Assignments</h2>
        <p>
