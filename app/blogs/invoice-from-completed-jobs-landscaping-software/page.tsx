...
export const metadata = {
  title: 'Invoicing From Completed Jobs: How Landscaping Software Bills the Work Your Crews Actually Did | LandscapeBossPro',
  description: 'See how LandscapeBossPro turns completed landscaping jobs into accurate invoices&mdash;billing the real materials, labor, and work your crews finished in the field.',
};
