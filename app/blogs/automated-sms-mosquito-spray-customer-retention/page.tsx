...
export const metadata = {
  title: 'How Automated SMS Retains Mosquito Spray Customers | LandscapeBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>LandscapeBossPro fires pre-service and post-service SMS from dispatch and completion events automatically — so professional customer communication happens on every route day without any manual effort from the office.</p>
          <a href="https://my.landscapebosspro.com">Start Free Trial</a>
        </div>

        <div className="blog-keywords">
          Keywords: automated sms mosquito spray customers, mosquito spray customer retention sms, mosquito spray pre-service alert, mosquito spray completion text message, mosquito spray customer communication software, mosquito spray re-entry interval sms, retain mosquito spray customers software
        </div>
      </article>
    </BlogShell>
  );
