...
export const metadata = {
  title: 'How Landscaping Software Keeps Clients Informed With Text Updates | LandscapeBossPro',
  description: 'See how landscaping software sends automatic text updates so clients always know when crews arrive, when jobs finish, and when invoices are due.',
};
