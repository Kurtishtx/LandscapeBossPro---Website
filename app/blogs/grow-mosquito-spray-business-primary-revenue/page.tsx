...
export const metadata = {
  title: 'Grow a Mosquito Spray Business to Primary Revenue | LandscapeBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>LandscapeBossPro is built for the full arc of a mosquito spray business — from 20 accounts as an add-on to 300 accounts as the primary revenue driver. Same platform. Same workflow. Scales with you.</p>
          <a href="https://my.landscapebosspro.com">Start Free Trial</a>
        </div>

        <div className="blog-keywords">
          Keywords: grow mosquito spray business primary revenue, mosquito spray business growth software, scale mosquito spray add-on to primary service, mosquito spray business scale 200 accounts, grow mosquito spray business software, mosquito spray business add-on to standalone
        </div>
      </article>
    </BlogShell>
  );
