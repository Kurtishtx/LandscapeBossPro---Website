...
export const metadata = {
  title: 'How the Crew Mobile App Powers Landscape Dispatch Software | LandscapeBossPro',
  description: 'See how the LandscapeBossPro crew mobile app turns dispatch software into live job updates, routing, materials tracking, and faster invoicing in the field.',
};
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        ...
        <h2>The Dispatch Board in Their Pocket</h2>
        <p>
        ...
        <h2>Routing That Saves Real Windshield Time</h2>
        <p>
