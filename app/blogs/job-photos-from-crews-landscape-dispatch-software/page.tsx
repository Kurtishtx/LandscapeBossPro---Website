...
export const metadata = {
  title: 'Collecting Before-and-After Photos From Dispatched Landscape Crews | LandscapeBossPro',
  description: 'See how LandscapeBossPro captures before-and-after job photos from dispatched landscape crews and ties them to property profiles, invoices, and proposals.',
};
