...
export const metadata = {
  title: 'Never Skip a Visit: How Landscape Maintenance Software Catches Misses | LandscapeBossPro',
  description: 'See how landscape maintenance software flags skipped visits with recurring schedules, crew dispatch tracking, and completion alerts so no property gets missed.',
};
