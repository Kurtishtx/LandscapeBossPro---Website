...
export const metadata = {
  title: 'Scaling from One Truck to Multiple Crews with Landscape Business Software | LandscapeBossPro',
  description: 'Landscape business software helps you go from one truck to multiple crews with shared estimates, scheduling, dispatch, materials tracking, and invoicing.',
};
