...
export const metadata = {
  title: 'Keeping the Office and the Field in Sync With Live Scheduling | LandscapeBossPro',
  description: 'See how live landscape scheduling software keeps your office and crews on the same page so jobs, materials, and crews never fall out of sync.',
};
