...
export const metadata = {
  title: 'Before-and-After Photo Documentation for Landscape Projects | LandscapeBossPro',
  description: 'See how LandscapeBossPro ties before-and-after job photos to estimates, materials, and invoices so every landscape project sells itself and protects your crews.',
};
