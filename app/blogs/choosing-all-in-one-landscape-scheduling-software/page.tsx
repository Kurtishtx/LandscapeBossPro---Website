...
export const metadata = {
  title: 'Why an All-in-One Beats Standalone Landscape Scheduling Apps | LandscapeBossPro',
  description: 'See why an all-in-one landscape scheduling software beats standalone apps by tying estimates, materials, dispatch, and invoicing to one calendar.',
};
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        ...
        <h2>The Hidden Cost of Bolting Apps Together</h2>
        <p>
