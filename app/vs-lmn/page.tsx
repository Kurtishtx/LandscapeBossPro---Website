...
export default function VsLmn() {
  ...
  return (
    <>
      ...
      <div className="hero">
        <div className="hero-badge">LMN Alternative</div>
        <h1>LMN Is Powerful but Heavy.<br /><span>LandscapeBossPro Gets You Running Today.</span></h1>
        <p>LMN (Landscape Management Network) is a capable landscape platform built around deep budgeting and estimating. But all that depth comes with steep setup, a learning curve, and pricing that climbs fast. LandscapeBossPro gives you line-item estimates, materials tracking, crew dispatch, and invoicing in one flat $129/month plan — without the weeks of configuration.</p>
        ...
        <div className="hero-stats">
          <div><div className="hero-stat-val">$129</div><div className="hero-stat-lbl">Flat Monthly vs LMN&apos;s Tiered Pricing</div></div>
          <div><div className="hero-stat-val">Unlimited</div><div className="hero-stat-lbl">Users — No Per-Seat Fees</div></div>
          <div><div className="hero-stat-val">1 Day</div><div className="hero-stat-lbl">Setup — Not Weeks of Onboarding</div></div>
      ...
      <section>
        <div className="centered" style={{maxWidth:'900px', margin:'0 auto'}}>
          ...
          <h2 className="section-title">LandscapeBossPro vs LMN</h2>
          <p className="section-sub">The features that matter most for running a landscaping business — without the complexity tax.</p>
        </div>
        <div className="compare-wrap">
          <table className="compare-table">
            ...
            <tbody>
              ...
              <tr><td className="feature-name">Fast Setup — Live the Same Day</td><td className="sbp-col"><span className="chk">✓</span></td><td><span className="crs">✗ Heavy onboarding</span></td></tr>
              <tr><td className="feature-name">No Required Training Course to Get Started</td><td className="sbp-col"><span className="chk">✓</span></td><td><span className="crs">✗</span></td></tr>
              <tr><td className="feature-name">True Two-Way SMS Inbox (Included)</td><td className="sbp-col"><span className="chk">✓</span></td><td><span className="prt">Add-on / limited</span></td></tr>
              ...
              <tr><td className="feature-name">Automated Review Requests</td><td className="sbp-col"><span className="chk">✓</span></td><td><span className="prt">Limited</span></td></tr>
              <tr><td className="feature-name">Automated Estimate Follow-Ups</td><td className="sbp-col"><span className="chk">✓</span></td><td><span className="prt">Limited</span></td></tr>
              ...
              <tr><td className="feature-name">Starting Price</td><td className="sbp-col" style={{color:'var(--orange)', fontWeight:800, fontSize:'15px'}}>$129 / month</td><td style={{color:'var(--muted)'}}>From ~$297/mo + onboarding</td></tr>
              <tr><td className="feature-name">Price for a Growing Crew</td><td className="sbp-col" style={{color:'var(--orange)', fontWeight:800}}>$129 / month</td><td style={{color:'var(--muted)'}}>Climbs with users &amp; modules</td></tr>
              <tr><td className="feature-name">Price with Two-Way SMS</td><td className="sbp-col" style={{color:'var(--orange)', fontWeight:800}}>$129 / month</td><td style={{color:'var(--muted)'}}>Higher tier / add-on</td></tr>
            </tbody>
          </table>
        </div>
      </section>
      ...
      <div className="premium-band">
        <h2>LMN Charges More as You Add Modules &amp; Seats.<br /><span>LandscapeBossPro Charges $129. Period.</span></h2>
        <p>LMN&apos;s power lives behind tiers, add-ons, and per-seat math — and the deeper budgeting tools take real time to set up before they pay off. LandscapeBossPro has one price — $129/month — that covers your entire crew, every feature, forever. No tiers. No per-seat math. No surprises on your invoice. You still get real line-item estimates, materials tracking, and crew dispatch — just without the heavy lift.</p>
        <div className="premium-grid">
          <div className="premium-card"><div className="premium-card-icon">📝</div><h4>Line-Item Estimates &amp; Bids</h4><p>Build detailed, professional estimates with labor, materials, and products broken out line by line. Clients accept online, and approved bids flow straight into scheduling. All the bidding power you need — none of the weeks of budget configuration.</p></div>
          <div className="premium-card"><div className="premium-card-icon">🌿</div><h4>Materials &amp; Products Tracking</h4><p>Keep your plants, sod, mulch, stone, pavers, and product catalog organized with costs that pull straight into estimates and jobs. Know your material spend per project without exporting to a spreadsheet.</p></div>
          <div className="premium-card"><div className="premium-card-icon">🚚</div><h4>Crew Dispatch &amp; Routing</h4><p>Assign projects and maintenance stops to crews, build efficient routes, and keep everyone moving. Your dispatch board shows the whole day at a glance — install, hardscape, planting, and recurring maintenance together.</p></div>
          <div className="premium-card"><div className="premium-card-icon">💬</div><h4>True Two-Way SMS Inbox</h4><p>Send and receive text messages inside LandscapeBossPro with full conversation history per client. No bolt-on, no separate tool — customer texting is included in your flat $129/month.</p></div>
          <div className="premium-card"><div className="premium-card-icon">🔁</div><h4>Recurring Maintenance Plans</h4><p>Set up recurring landscape maintenance schedules per property, track what&apos;s due, and bill automatically. Keep mowing, bed care, and seasonal cleanups on a predictable cadence without manual rescheduling.</p></div>
          <div className="premium-card"><div className="premium-card-icon">👥</div><h4>Unlimited Users, One Price</h4><p>Every employee — crews, foremen, office staff, managers — included at $129/month. LMN scales price with users and modules. Add your next crew member and your bill stays the same.</p></div>
        </div>
      </div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <h2>LMN Is Built for Deep Budgeting.<br />LandscapeBossPro Is Built to Get You Working Fast.</h2>
            <p>LMN is a serious platform with deep estimating and budgeting tools. But that depth means heavy setup, a real learning curve, and a price that climbs as you add seats and modules. Most landscaping owners don&apos;t need a financial-modeling cockpit — they need fast, accurate estimates, materials they can track, crews they can dispatch, and invoices that get paid. LandscapeBossPro does all of that on day one.</p>
            <ul className="check-list">
              <li>Line-item estimates and bids your clients can accept online</li>
              <li>Materials &amp; product catalog with costs that flow into every job</li>
              <li>Project scheduling for install, hardscape, planting, and sod</li>
              <li>Crew dispatch and routing from one clean board</li>
              <li>Recurring maintenance plans with automatic due-date tracking</li>
              <li>Invoicing with card-on-file payments built in</li>
              <li>True inbound/outbound SMS inbox organized by client</li>
          ...
          <div className="highlight-visual">
            ...
            <div className="mock-item">
              ...
              <div><div className="mock-label">LandscapeBossPro</div><div className="mock-sub">Unlimited users — every feature — SMS included</div></div>
              <div className="mock-badge">$129/mo</div>
            </div>
            <div className="mock-item">
              <div className="mock-dot blue"></div>
              <div><div className="mock-label">LMN Pro</div><div className="mock-sub">Core estimating &amp; budgeting — per-seat add-ons</div></div>
              <div className="mock-badge blue-badge">~$297/mo</div>
            </div>
            <div className="mock-item">
              <div className="mock-dot green"></div>
              <div><div className="mock-label">LMN Pro + Add-Ons</div><div className="mock-sub">Time tracking, more seats, extra modules</div></div>
              <div className="mock-badge green-badge">More/mo</div>
            </div>
            <div className="mock-item">
              <div className="mock-dot" style={{background:'#176329'}}></div>
              <div><div className="mock-label">Onboarding &amp; Training</div><div className="mock-sub">Setup time before it pays off</div></div>
              <div className="mock-badge" style={{background:'#11501f'}}>Weeks</div>
            </div>
            <div style={{marginTop:'16px', background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'14px 16px'}}>
              <div style={{color:'var(--orange)', fontSize:'13px', fontWeight:700, marginBottom:'8px'}}>LandscapeBossPro keeps it simple:</div>
              <div style={{color:'rgba(255,255,255,.6)', fontSize:'12px', lineHeight:2}}>✓ Line-Item Estimates &amp; Bids<br />✓ Materials &amp; Products Tracking<br />✓ Crew Dispatch &amp; Routing<br />✓ Recurring Maintenance Plans<br />✓ Invoicing &amp; Card-on-File Payments</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="estimates" className="dark-section">
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <h2 style={{color:'#fff'}}>All the Bidding Power. None of the Setup Tax.</h2>
            <p style={{color:'rgba(255,255,255,.65)'}}>Build line-item estimates for installs, hardscape, planting, and sod — labor, materials, and products broken out so your margins are clear. Materials pull straight from your catalog with current costs. Clients accept online, and approved bids flow into scheduling and invoicing. With LMN you configure budgets for weeks before you bid. With LandscapeBossPro you bid your first job today.</p>
            <ul className="check-list" style={{marginTop:'20px'}}>
              <li style={{color:'rgba(255,255,255,.75)'}}>Line-item labor, materials, and products on every estimate</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Material costs pull live from your products catalog</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Clients review and accept bids online in one click</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Approved estimates flow straight into scheduling</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Convert a won bid to an invoice without re-keying anything</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Track material spend per project automatically</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>No multi-week budget build before you can send a quote</li>
            </ul>
          </div>
          <div className="highlight-visual">
            <div style={{color:'rgba(255,255,255,.5)', fontSize:'11px', textTransform:'uppercase', letterSpacing:'1px', marginBottom:'12px'}}>Estimate — Backyard Patio &amp; Planting</div>
            <div className="mock-item">
              <div className="mock-dot orange"></div>
              <div><div className="mock-label">Paver Patio — 420 sq ft</div><div className="mock-sub">Materials + labor, line-itemed</div></div>
              <div className="mock-badge">$8,640</div>
            </div>
            <div className="mock-item">
              <div className="mock-dot green"></div>
              <div><div className="mock-label">Planting — 24 Shrubs, 6 Trees</div><div className="mock-sub">Stock pulled from products catalog</div></div>
              <div className="mock-badge green-badge">$3,180</div>
            </div>
            <div className="mock-item">
              <div className="mock-dot blue"></div>
              <div><div className="mock-label">Mulch &amp; Bed Prep — 14 yd</div><div className="mock-sub">Material cost auto-calculated</div></div>
              <div className="mock-badge blue-badge">$1,260</div>
            </div>
            <div className="stat-grid">
              <div className="stat-cell"><div className="stat-val">$13,080</div><div className="stat-lbl">Estimate Total</div></div>
              <div className="stat-cell"><div className="stat-val">38%</div><div className="stat-lbl">Projected Margin</div></div>
              <div className="stat-cell"><div className="stat-val">3</div><div className="stat-lbl">Crew Days</div></div>
              <div className="stat-cell"><div className="stat-val">$5,700</div><div className="stat-lbl">Material Cost</div></div>
              <div className="stat-cell full"><div className="stat-val">Hardscape · Planting · Bed Prep — Accepted Online</div><div className="stat-lbl">Bid Breakdown by Scope</div></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          ...
          <h2 className="section-title">Easier to Learn Than LMN. Still Built for Landscaping.</h2>
          <p className="section-sub" style={{maxWidth:'720px'}}>LMN is powerful, but that power comes with weeks of setup and a training course before it earns its keep. LandscapeBossPro was designed so a landscaping owner can sit down, build an estimate, schedule a crew, and send an invoice the same afternoon — less configuration, less hunting through menus, more work getting done.</p>
        </div>
        <div className="simple-grid">
          <div className="simple-card"><div className="simple-num">01</div><h3>Set Up in One Afternoon</h3><p>Add your services and material catalog, import clients and properties, connect payments, set up your SMS alerts — most owners are fully operational the same day. No onboarding call, no implementation consultant, no multi-week timeline before you can bid.</p></div>
          <div className="simple-card"><div className="simple-num">02</div><h3>Built Around the Job &amp; Dispatch Board</h3><p>Everything flows through one board — estimates, projects, scheduling, dispatch, invoicing. It&apos;s designed the way a landscaping business actually runs its day, from install to recurring maintenance, not the way an accountant models a budget.</p></div>
          <div className="simple-card"><div className="simple-num">03</div><h3>Crews Are Up and Running Fast</h3><p>The mobile app shows your crews exactly what they need — today&apos;s projects and stops, property notes, materials, and the complete button. No training videos, no IT ticket, no confused crew. They&apos;re using it on day one.</p></div>
          <div className="simple-card"><div className="simple-num">04</div><h3>Automation That Actually Runs</h3><p>SMS alerts, estimate follow-ups, payment reminders, review requests — set them up once and LandscapeBossPro runs them every time, automatically. You&apos;re not babysitting automations or configuring complex workflows.</p></div>
        </div>
      </section>
      ...
      <div className="cta-band">
        <h2>Ready to Switch from LMN to Software<br />That Gets You Working Today?</h2>
