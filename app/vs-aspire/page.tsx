    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .cost-box.sbp { background: linear-gradient(135deg, var(--purple-deep) 0%, #15321f 100%); border: 2px solid rgba(27,110,59,.4); }
            ...
            <div className="highlight-visual" style={{flex:1.5, minWidth:'280px'}}>
              <div className="cost-compare">
                ...
                <div className="cost-box sbp">
                  <div className="cost-box-label">LandscapeBossPro</div>
              ...
              <div className="cost-rows">
                ...
                <div className="cost-row"><span className="cost-row-label">LandscapeBossPro Pricing</span><span className="cost-row-val orange">$129/mo flat — published</span></div>
                ...
                <div className="cost-row"><span className="cost-row-label">LandscapeBossPro Trial</span><span className="cost-row-val green">14 days free — no card</span></div>
              </div>
            </div>
