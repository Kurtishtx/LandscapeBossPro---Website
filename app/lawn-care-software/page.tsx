  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <p>Most field service software is built for plumbers and HVAC techs. LandscapeBossPro is built from the ground up for lawn care businesses — the way you schedule, route, track, and bill is completely different, and your software should be too.</p>
      ...
      <div style={{background:'var(--purple-dark)', padding:'0 40px 60px', textAlign:'center'}}>
        <img
          ...
          fetchPriority="high"
          decoding="async"
          alt="LandscapeBossPro lawn care software dashboard on laptop showing circle-map route builder and waiting list, with mobile app on phone"
      ...
      <section className="dark-section">
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <p style={{color:'rgba(255,255,255,.65)'}}>Lasso is the fastest way to build a lawn care route we&apos;ve ever seen. Draw a circle on your service area map and LandscapeBossPro instantly surfaces every property inside that radius that has a service due — with total square footage, service types, stops, and revenue all calculated in real time before you commit to a single schedule.</p>
          ...
          <div className="highlight-visual">
            ...
            <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'8px'}}>
              ...
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px'}}>
                <div style={{color:'#1b6e3b', fontSize:'18px', fontWeight:800}}>19</div>
                <div style={{color:'rgba(255,255,255,.42)', fontSize:'11px', marginTop:'1px'}}>Total Services</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px'}}>
                <div style={{color:'#1b6e3b', fontSize:'18px', fontWeight:800}}>118,400</div>
                <div style={{color:'rgba(255,255,255,.42)', fontSize:'11px', marginTop:'1px'}}>Sq Ft (Lawn)</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px'}}>
                <div style={{color:'#1b6e3b', fontSize:'18px', fontWeight:800}}>4,200</div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          ...
          <p className="section-sub" style={{maxWidth:'720px'}}>Most powerful software is complicated. LandscapeBossPro is the exception. Every screen was designed by people who ran lawn care routes — not UX designers who&apos;ve never touched a spray rig. Your team will be using it confidently on day one.</p>
        </div>
        <div style={{display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(240px, 1fr))', gap:'24px', maxWidth:'1100px', margin:'0 auto'}}>
          {[
            ...
            {n:'04', title:'Automation Runs Without You', body:'Set up your SMS alerts, estimate follow-ups, and payment reminders once. After that, LandscapeBossPro handles every notification, every follow-up, and every review request automatically — whether you\'re on a route, at home, or on vacation.'},
          ].map(({n, title, body}) => (
      ...
      <section style={{background:'var(--light-bg)'}}>
        ...
        <div style={{maxWidth:'900px', margin:'0 auto'}}>
          <div style={{background:'#fff', border:'1.5px solid var(--border)', borderRadius:'14px', padding:'36px 40px', borderLeft:'5px solid var(--orange)'}}>
            ...
            <p style={{fontSize:'17px', color:'var(--text)', lineHeight:1.8, marginBottom:'16px'}}>They don&apos;t have that. Because they weren&apos;t built by someone who runs a lawn care business. <strong>We were.</strong> We&apos;ve been in this industry since 2006, and LandscapeBossPro is the software we always wished existed.</p>
            <p style={{fontSize:'17px', color:'var(--text)', lineHeight:1.8}}>Every feature in LandscapeBossPro exists because we needed it on a real lawn care route. Not because a product manager in a tech office decided it sounded good.</p>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="centered" style={{maxWidth:'1200px', margin:'0 auto'}}>
          ...
          <p className="section-sub">Every tool in LandscapeBossPro was built with lawn care workflows in mind — not adapted from a plumbing app and called good enough.</p>
        </div>
        <div className="feature-grid">
          {[
            {icon:'📋', title:'Sq Ft Waiting List', body:'Before you schedule a single stop, LandscapeBossPro shows you the exact square footage waiting for every service type on your list. Know how much Lawn Care 4, Mosquito, or Insect Control you can fit in a day before you make a single call.'},
            ...
            {icon:'📦', title:'Lawn Care Package Programs', body:'Create 6-application or custom package programs, assign clients to them, and track renewal dates. LandscapeBossPro alerts you when packages are coming due so nothing falls through the cracks.'},
            {icon:'💬', title:'Automated Service Alerts', body:'Automatically text customers when a service is scheduled, when your tech is on the way, and when the job is done. Set it once — LandscapeBossPro handles the communication for every single stop.'},
            ...
            {icon:'⭐', title:'Automated Review Requests', body:'After every completed service, LandscapeBossPro automatically sends a Google review request to the customer — on your schedule, every time, without you lifting a finger.'},
            {icon:'🔁', title:'Estimate Follow-Up Sequences', body:'3 automated follow-up texts go out if a client doesn\'t respond to your estimate. Let LandscapeBossPro chase the deal so you don\'t have to.'},
        ...
        <div className="highlight-row">
          ...
          <div className="highlight-visual">
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              ...
              <div style={{marginLeft:'auto', background:'#1b6e3b', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>246,500 ft²</div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
            ...
            <div style={{marginTop:'16px', background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'14px 16px', textAlign:'center'}}>
              <div style={{color:'#1b6e3b', fontSize:'16px', fontWeight:700}}>Know before you dial.</div>
      ...
      <section>
        <div className="highlight-row reverse">
          <div className="highlight-text">
            ...
            <p>Every state requires pesticide application records. LandscapeBossPro makes compliance automatic — every application is logged the moment the job is marked complete, and you can pull a full report for any inspector in under 30 seconds.</p>
            <ul className="check-list">
          ...
          <div className="highlight-visual">
            ...
            <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'8px', marginBottom:'12px'}}>
              ...
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
                <div style={{color:'#1b6e3b', fontSize:'20px', fontWeight:700}}>1.1M</div>
                <div style={{color:'rgba(255,255,255,.45)', fontSize:'11px'}}>Sq Ft Treated</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
                <div style={{color:'#1b6e3b', fontSize:'20px', fontWeight:700}}>412</div>
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', display:'flex', alignItems:'center', gap:'12px'}}>
              ...
              <div style={{background:'#1b6e3b', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>9 gal</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{background:'#fff'}}>
        <div style={{maxWidth:'860px', margin:'0 auto', padding:'80px 40px'}}>
          ...
          {[
            {q:'Is LandscapeBossPro built for lawn care businesses?', a:'Yes. LandscapeBossPro handles the full lawn care operation: recurring program scheduling, sq ft-based route building, chemical application logs, estimate-to-service conversion, automated customer SMS, and card-on-file payments. It\'s designed for companies running treatment routes, not general service businesses.'},
            {q:'Can I manage multiple service types — lawn care, weed control, fertilizer — in one platform?', a:'Yes. LandscapeBossPro supports multiple service types from one account, with separate waiting lists by service category. You can run lawn care, weed control, fertilizer, and pest control routes simultaneously with service-specific SMS alerts and independent pricing.'},
            ...
            {q:'Does LandscapeBossPro track chemical applications for lawn care?', a:'Yes. Every treatment logs the product, EPA registration number, rate, and area treated. The chemical compliance report generates a formatted log for state inspector requirements — no separate paper records needed.'},
            {q:'Does it replace spreadsheets and scheduling apps?', a:'Yes. LandscapeBossPro replaces spreadsheet scheduling, route planning, customer tracking, and SMS communication tools in one platform. Most owners are fully operational the same day they sign up — no onboarding consultant, no implementation timeline.'},
            {q:'How much does LandscapeBossPro cost?', a:'$129/month, all features included. No per-user fees, no add-ons for SMS or route tools, no setup fees. 14-day free trial with no credit card required.'},
          ].map(({q, a}, i, arr) => (
          ...
          <p style={{marginTop:'40px', color:'var(--muted)', fontSize:'15px', lineHeight:1.7}}>LandscapeBossPro handles lawn care alongside weed control, fertilizer, pest control, and mosquito spray — all from one platform — <a href="/" style={{color:'var(--orange)', fontWeight:600}}>see the full platform overview</a>.</p>
        </div>
      </section>
      ...
      <div className="cta-band">
        ...
        <p>LandscapeBossPro is the only lawn care management software built by someone who has actually run a spray route. Try it free for 14 days.</p>
        <div className="hero-btns">
